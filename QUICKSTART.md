...
**Key points (Apple standards):**
- Only 2 widget sizes: `small` (170×170px square) and `large` (360×170px wide rectangle)
- Consistent 16px padding (p-4) and 24px border radius (rounded-3xl)
